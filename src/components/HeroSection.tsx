  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-hero">
      ...
      <div className="absolute inset-0 opacity-20">
        ...
        <div className="absolute top-1/2 right-1/3 w-40 h-40 rounded-full bg-cyber-blue animate-glow-pulse" style={{animationDelay: '1s'}}></div>
      </div>
      ...
      <div className="container mx-auto px-4 grid lg:grid-cols-2 gap-12 items-center relative z-10">
        ...
        <div className="text-center lg:text-left space-y-8 animate-slide-up-fade">
          <div className="space-y-4">
            <h1 className="text-5xl lg:text-7xl font-black leading-tight">
              Your Website 
              <span className="bg-gradient-accent bg-clip-text text-transparent"> Shouldn't </span>
              <br />
              <span className="text-neon-orange animate-neon-flicker">Suck</span>
            </h1>
            
            <p className="text-xl lg:text-2xl text-muted-foreground font-medium max-w-2xl">
              Look legit in <span className="text-electric font-bold">3 days or less</span>. 
              Premium websites that convert visitors into customers, not just pretty pictures.
            </p>
          </div>
        ...
        <div className="relative animate-bounce-in" style={{animationDelay: '0.3s'}}>
          <div className="relative">
            ...
            {/* Floating elements */}
            <div className="absolute -top-4 -right-4 bg-gradient-accent text-white px-4 py-2 rounded-full text-sm font-bold animate-bounce-in" style={{animationDelay: '1s'}}>
              ✨ Mobile-First
            </div>
            
            <div className="absolute -bottom-4 -left-4 bg-gradient-primary text-white px-4 py-2 rounded-full text-sm font-bold animate-bounce-in" style={{animationDelay: '1.2s'}}>
              🔥 SEO Ready
            </div>
          </div>
        </div>
