  ...
  const features = [
    {
      ...
      description:
        "3-day average turnaround. No months of waiting. Your business needs speed.",
      highlight: "3 Days",
    },
    {
      icon: "📱",
      ...
      description:
        "80% of your traffic is mobile. We design for phones first, desktop second.",
    ...
    },
    {
      ...
      title: "SEO Optimized",
      description:
        "Built to rank. Clean code, fast loading, optimized for Google from day one.",
    ...
    },
    {
      ...
      description:
        "Pretty doesn't pay bills. Every element designed to turn visitors into customers.",
    ...
    },
    {
      ...
      title: "Custom Coded",
      description:
        "No WordPress plugins. Hand-coded React for maximum performance and security.",
    ...
    },
    {
      ...
      description:
        "DM me anytime. No corporate bullshit. Just real talk about your vision.",
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="text-center mb-16 animate-slide-up-fade">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            I'm not just another web designer. I'm the plug for websites that
            actually work.
          </p>
        </div>
        ...
        <div className="text-center bg-gradient-primary rounded-3xl p-12 animate-slide-up-fade">
          ...
          <p className="text-xl text-white/90 mb-8 max-w-2xl mx-auto">
            Join the creators, entrepreneurs, and hustlers who chose premium
            over basic.
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Button
              ...
              onClick={() => (window.location.href = "https://zeirrow-dev-six.vercel.app/")}
            >
              See Portfolio
            </Button>
          </div>
